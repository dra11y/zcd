...
#[test]
fn completions_bash() {
    let source = include_str!("../contrib/completions/zcd.bash");
    Command::new("bash")
...
#[test]
fn completions_fish() {
    let source = include_str!("../contrib/completions/zcd.fish");
...
fn completions_powershell() {
    let source = include_str!("../contrib/completions/_zcd.ps1");
    Command::new("pwsh")
